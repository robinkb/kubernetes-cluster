...
A [timoni.sh](http://timoni.sh) module for deploying matchbox to Kubernetes clusters.
...
```shell
timoni -n default apply matchbox oci://<container-registry-url>
```
...
```shell
timoni -n default delete matchbox
```
