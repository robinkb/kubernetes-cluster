...
#Instance: {
	...
	objects: {
		...
		caCert: #CACertificate & {#config: config}
		serverCert: #ServerCertificate & {#config: config}
		clientCert: #ClientCertificate & {#config: config}
		sa: #ServiceAccount & {#config: config}
		headlessService: #HeadlessService & {#config: config}
		rpcService: #RPCService & {#config: config}
		httpService: #HTTPService & {#config: config}
