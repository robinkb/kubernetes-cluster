...
A [timoni.sh](http://timoni.sh) module for deploying metallb-resources to Kubernetes clusters.
...
```shell
timoni -n default apply metallb-resources oci://<container-registry-url>
```
...
```shell
timoni -n default delete metallb-resources
```
