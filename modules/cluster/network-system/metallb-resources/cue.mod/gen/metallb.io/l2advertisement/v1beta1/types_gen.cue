...
//timoni:generate timoni vendor crd -f https://github.com/metallb/metallb/raw/main/config/crd/bases/metallb.io_l2advertisements.yaml
...
// provided by the selected pools via L2.
#L2Advertisement: {
...
#L2AdvertisementSpec: {
	...
	// announced only from these interfaces. If the field is not set,
	// we advertise from all the interfaces on the host.
	interfaces?: [...string]

	// A selector for the IPAddressPools which would get advertised
	// via this advertisement. If no IPAddressPool is selected by
	// this or by the list, the advertisement is applied to all the
	// IPAddressPools.
