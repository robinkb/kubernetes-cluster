...
A [timoni.sh](http://timoni.sh) module for deploying seaweedfs to Kubernetes clusters.
...
```shell
timoni -n default apply seaweedfs oci://<container-registry-url>
```
...
```shell
timoni -n default delete seaweedfs
```
