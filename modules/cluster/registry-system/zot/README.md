...
A [timoni.sh](http://timoni.sh) module for deploying zot to Kubernetes clusters.
...
```shell
timoni -n default apply zot oci://<container-registry-url>
```
