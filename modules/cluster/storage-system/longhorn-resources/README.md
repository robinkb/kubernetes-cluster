...
A [timoni.sh](http://timoni.sh) module for deploying longhorn-resources to Kubernetes clusters.
...
```shell
timoni -n default apply longhorn-resources oci://<container-registry-url>
```
...
```shell
timoni -n default delete longhorn-resources
```
